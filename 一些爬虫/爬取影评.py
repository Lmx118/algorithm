...
urls = ['https://movie.douban.com/subject/25853071/comments?start={}&limit=20&status=P&sort=new_score'.format(str(i))
...
with open('庆余年评论2.txt', 'w', encoding='utf-8-sig') as f:  # 使用with open()新建对象f
    # 将列表中的数据循环写入到文本文件中
